...
public class CameraBoxSelectionDetector {
	...
	public void selectGameItem(final GameItem[] gameItems, final Camera camera) {
		dir = camera.getViewMatrix().positiveZ(dir).negate();
		selectGameItem(gameItems, camera.getPosition(), dir);
	}

	protected boolean selectGameItem(final GameItem[] gameItems, final Vector3f center, final Vector3f dir) {
