...
public class Main {
	...
	public static void main(String[] args) {
		try {
			...
			IGameLogic gameLogic = new Bokuseru(); // specify which game logic
													// the engine will run
			Window.WindowOptions opts = new Window.WindowOptions(); // create
																	// the GLFW
																	// window
			opts.cullFace = true;
			opts.showFps = true;
			...
			GameEngine gameEng = new GameEngine("Bokuseru", vSync, opts, gameLogic); // specify
																						// which
																						// game
																						// the
																						// engine
